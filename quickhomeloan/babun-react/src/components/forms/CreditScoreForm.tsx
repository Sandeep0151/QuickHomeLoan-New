...
import { getCSRFToken } from "../../utils/getCsrfToken"; // Helper function for CSRF token
    ...
    try {
      ...
      },
      {
        headers: {
           ...
           "X-CSRFToken": csrfToken, // Make sure this function works
        }
      }

      );
      setMessage(response.data.message);
      setFormData({ fullName: "", dob: "", mobile: "", email: "", pan: "" });
    } catch (error) {
